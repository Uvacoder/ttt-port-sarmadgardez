export const serviceDefinitions = [
  {
    ...
    summary: 'I will build a fully functional React Native Application',
    content: {
      title: {
      ...
      description: [
        'I will fully create a functional react native application for for both plateform UX - UI designing including the Android & IOS',
